...
<body>
	...
	<ul
		...
		<!-- Nav Item - Dashboard -->
		<li class="nav-item active"><a class="nav-link" href="<c:url value="/admin-home" />">
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			aria-controls="collapseTwo"> <i class="fas fa-fw fa-cog"></i> <span>Bài Viết</span>
		</a>
			<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
				data-parent="#accordionSidebar">
				<div class="bg-white py-2 collapse-inner rounded">
					<a class="collapse-item" href="${listURL}">Danh sách bài viết</a> 
				</div>
			</div></li>
